...
docker build -t theoriginaltonystark/temperaturecenter_web-server:latest .
docker build -t theoriginaltonystark/temperaturecenter_web-server:${APPLICATION_VERSION} .
